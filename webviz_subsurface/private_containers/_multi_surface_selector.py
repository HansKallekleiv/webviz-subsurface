...
"""
    ...
    def set_ids(self):
        ...
        self.aggregation_id = f"{uuid}-aggregation-id"
        ...
        return html.Div(
            ...
            children=[
                ...
                html.Div(
                    style=self.set_grid_layout("6fr 1fr"),
                    children=[
                        dcc.Dropdown(id=self.name_id, multi=True, clearable=False),
                        self._make_buttons(
        ...
        return html.Div(
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        dcc.Dropdown(
                            id=self.realization_id, multi=False, clearable=False
                        )
                    ],
                ),
                html.Div(
    ...
    def set_callbacks(self, app):
        ...
        def _update_name(attr, current_values):
            ctx = dash.callback_context.triggered
            if not ctx:
                raise PreventUpdate
        ...
        def _update_real(
            ensemble, _n_prev, _n_next, sens_name, sens_case, current_value
        ):
            ctx = dash.callback_context.triggered
            if not ctx:
                raise PreventUpdate
        ...
        @app.callback(
            ...
            [
                ...
                Input(self.ensemble_id, "value"),
                Input(self.aggregation_id, "value"),
        ...
        def _set_data(
            attr, names, date, ensemble, aggregations, realization, sens_name, sens_case
        ):
