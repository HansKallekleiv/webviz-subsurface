        ...
        initial_settings:
            intersection_data: # Data to populate the intersection view
                ...
                realizations: #List of active realizations
                    - 0
                distance: 20 # Horizontal distance between points in theintersection
                             # (Usually in meters)
                atleast: 5 # Minimum number of points.
                nextend: 2 # Horizontal extension of the intersection (distance*nextend)
            ...
            children=[
                ...
                wcc.FlexBox(
                    children=[
                        ...
                        html.Div(
                            id={
                                "id": self.uuid("uncertainty-table"),
                                "element": "wrapper",
                            },
                            className="framed",
                            style={"flex": 3, "display": "none"},
                ...
                modal.modal_layout(
                    uuid=self.uuid("modal"),
                    modal_id="color",
                    title="Color settings (click on a color cell in the table "
                ...
                modal.modal_layout(
                    ...
                    body_children=[
                        realization_layout(
                            uuid=self.uuid("intersection_data"),
                            realizations=self._realizations,
